...
// non possiamo accedere alle informazioni di pacman, usare le funzioni di libreria per ottenere. 
//utilizzare le funzioni di libreiria 
//tipo: pacman_get_position
